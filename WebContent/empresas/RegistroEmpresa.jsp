        ...
        <div class="row">
            ...
            <div class="col-12 mt-5">
                <div class="d-flex justify-content-center align-items-center">
                    <form class="w-50 shadow-lg p-3 mb-5 bg-white rounded p-5" action="${pageContext.request.contextPath}/empresas.do" method="POST">
                        <input type="hidden" name="op" value="validar">
                        <div class="row">
                            <div class="col-6 mt-3">
                                <span>Nombre Empresa</span>
                                <input type="text" class="form-control" id="nombreRegistroEmpresa" name="empresaNombre" required>
                            </div>
                            <div class="col-6 mt-3">
                                <span>Contacto</span>
                                <input type="text" class="form-control" id="contactoEmpresa" name="empresaContacto" required>
                            </div>
                            ...
                            <div class="col-6 mt-3">
                                ...
                                title="Solo acepta números en el siguiente formato: 2222-2222" name="telefonoEmpresa" required>
                            </div>
                            <div class="col-6 mt-3">
                            ...
                            <div class="col-6 mt-3">
                                ...
                                <input type="email" class="form-control" id="emialEmpresa" name="correoEmpresa" required>
                            </div>

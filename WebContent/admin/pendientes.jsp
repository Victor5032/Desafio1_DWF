                    ...
                    <div class="row">
                        <div class="col-12">
                            <nav class="nav nav-pills nav-justified">
                                <a class="nav-link" href="admin.do?op=home">Todas las ofertas</a>
                                <a class="nav-link active" aria-current="page" href="admin.do?op=standby">Ofertas pendientes de aprobación</a>
                            </nav>
                            <br>

...
public class SendEmail {
	...
	public void conFirmacionPago(String destinatario, String nombres, String apellidos, String codigoCupon) throws MessagingException {
		String nombresApellidos = nombres + " " + apellidos;
		String destinatarioString = destinatario;
		...
		Message message = confirMacionCompra(session, password, destinatarioString, nombresApellidos, codigoCupon);
		 Transport.send(message);
	}
	
	private static Message confirMacionCompra(Session session, String myAcountString, String destinatario, String nombresApellidos, String codigoCupon) {
		try {
			Message message = new MimeMessage(session);
			message.setFrom(new InternetAddress(myAcountString));
			message.setRecipient(Message.RecipientType.TO, new InternetAddress(destinatario));
			message.setSubject("Felicidades" + nombresApellidos + "tu compra fue exitosa");
			message.setContent(
					...
					+ "      \n"
					+ "      <img align=\"center\" border=\"0\" src=\"https://lh3.googleusercontent.com/Jdvw4AV3buw8plSy5S-51t9ep_ABAHu7K8bPThWgV-4zv0S4C76rE1W_9ZPfL4aD9LI7_Q=s113\" alt=\"Image\" title=\"Image\" style=\"outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 26%;max-width: 150.8px;\" width=\"150.8\"/>\n"
					+ "      \n"
					+ "    </td>\n"
					+ "  </tr>\n"
					+ "</table>\n"
					...
					+ "    <p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 26px; line-height: 36.4px;\"><strong><span style=\"line-height: 36.4px; font-size: 26px;\">Tu compra ha sido exitosa!</span></strong></span></p>\n"
					+ "  </div>\n"
					+ "\n"
					+ "      </td>\n"
					+ "    </tr>\n"
					...
					+ "    <p style=\"font-size: 14px; line-height: 210%;\"><span style=\"font-size: 16px; line-height: 33.6px;\">Estimado "+nombresApellidos+",</span></p>\n"
					+ "<p style=\"font-size: 14px; line-height: 210%;\">Su compra se ha realizado con &eacute;xito, el c&oacute;digo de su cup&oacute;n es el siguiente:</p>\n"
					+ "<p style=\"font-size: 14px; line-height: 210%;\">&nbsp;</p>\n"
					+ "<p style=\"font-size: 14px; line-height: 210%;\">&nbsp;</p>\n"
					+ "<p style=\"font-size: 14px; line-height: 210%;\"><h1><b>"+codigoCupon+"</b></h1></p>\n"
					+ "<p style=\"font-size: 14px; line-height: 210%;\">&nbsp;</p>\n"
					+ "<p style=\"font-size: 14px; line-height: 210%; text-align: left;\">Para poder canjearlo, presenta tu numero de DUI y este c&oacute;digo en el establecimiento con el que adquiriste el cup&oacute;n.</p>\n"
					+ "  </div>\n"
					+ "\n"
					+ "      </td>\n"
					+ "    </tr>\n"
					...
					+ "    <p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 12px; line-height: 16.8px;\">La cuponera DWF</span></p>\n"
					+ "<p style=\"font-size: 14px; line-height: 140%;\">&nbsp;</p>\n"
					+ "<p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 12px; line-height: 16.8px;\">Universidad Don Bosco </span></p>\n"
					+ "<p style=\"font-size: 14px; line-height: 140%;\">&nbsp;</p>\n"
					+ "<p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 12px; line-height: 16.8px;\">&copy; 2021 Company, Inc</span></p>\n"
					+ "  </div>\n"
					+ "\n"
					+ "      </td>\n"
					+ "    </tr>\n"
	...
	public String restablecerPasswordCliente(String destino) throws MessagingException{
		Token newToken = new Token();
		String newPasswordString =newToken.password();
		String destinatario = destino;
		...
		Message message = prepareMessageRecuperacionCliente(session, myAccountEmail, destino, newPasswordString);
		if(message == null) {
			return "";
		}else {
	    Transport.send(message);
	...
	private static Message prepareMessageRecuperacionCliente(Session session, String myAccountEmail, String destino, String passwordString) {
		try {
			Message message = new MimeMessage(session);
			...
			message.setContent("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n"
					...
					+ "      <!--[if (mso)|(IE)]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td style=\"padding: 0px;background-color: transparent;\" align=\"center\"><table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"width:600px;\"><tr style=\"background-color: #ffffff;\"><![endif]-->\n"
					+ "      \n"
					+ "<!--[if (mso)|(IE)]><td align=\"center\" width=\"600\" style=\"background-color: #0c0c30;width: 600px;padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;\" valign=\"top\"><![endif]-->\n"
					+ "<div class=\"u-col u-col-100\" style=\"max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;\">\n"
					+ "  <div style=\"background-color: #0c0c30;width: 100% !important;\">\n"
					+ "  <!--[if (!mso)&(!IE)]><!--><div style=\"padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;\"><!--<![endif]-->\n"
					+ "  \n"
					+ "<table style=\"font-family:'Lato',sans-serif;\" role=\"presentation\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" border=\"0\">\n"
					+ "  <tbody>\n"
					...
					+ "    <p style=\"font-size: 14px; line-height: 140%; text-align: center;\"><span style=\"font-size: 28px; line-height: 39.2px; color: #ffffff; font-family: Lato, sans-serif;\">Se ha reseteado tu contrase&ntilde;a</span></p>\n"
					+ "  </div>\n"
					+ "\n"
					+ "      </td>\n"
					+ "    </tr>\n"
					...
					+ "<p style=\"font-size: 14px; line-height: 140%;\">&nbsp;</p>\n"
					+ "<p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 18px; line-height: 25.2px; color: #666666;\">En este email esta tu nueva contrase&ntilde;a para que puedas ingresar a tu cuenta </span></p>\n"
					+ "<p style=\"font-size: 14px; line-height: 140%;\">&nbsp;</p>\n"
					+ "<p style=\"line-height: 140%; font-size: 14px;\"><span style=\"color: #666666; font-size: 14px; line-height: 19.6px;\"><span style=\"font-size: 18px; line-height: 25.2px;\">Se detalla la contrase&ntilde;a a continuaci&oacute;n.</span><rb><h1><b>"+passwordString+"</b></h1></rb></span></p>\n"
					...
					+ "      <td style=\"overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Lato',sans-serif;\" align=\"left\">\n"
					+ "        \n"
					+ "  <div style=\"color: #fafafa; line-height: 140%; text-align: left; word-wrap: break-word;\">\n"
					+ "    <p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 16px; line-height: 22.4px; color: #ecf0f1;\">Universidad Don Bosco </span></p>\n"
					+ "<p style=\"font-size: 14px; line-height: 140%;\">&nbsp;2021 DWF</p>\n"
					+ "  </div>\n"
					+ "\n"
					+ "      </td>\n"
					+ "    </tr>\n"
	...
	public  String sendTokenCliente(String destino, String nombre, String apellidos) throws MessagingException {
		Token newTokem = new Token();
		String generatedTokemCliente = newTokem.token();
		String destinatario = destino;
		...
		Message message = perpareMessageCliente(session, myAccountEmail, destinatario, generatedTokemCliente, nombreApellidos);
		if(message == null) {
			return "";
		}else {
	    Transport.send(message);
	       return generatedTokemCliente;
		}
	
	}
	
	private static Message perpareMessageCliente(Session session, String myAcountString, String destinatario, String tokem, String nombreApellidoCliente) {
		try {
			Message message = new MimeMessage(session);
			message.setFrom(new InternetAddress(myAcountString));
			message.setRecipient(Message.RecipientType.TO, new InternetAddress(destinatario));
			message.setSubject("Estimado "+nombreApellidoCliente+" este es tu codigo de verificacion");
			message.setContent(
					"<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n"
					+ "<html xmlns=\"http://www.w3.org/1999/xhtml\" xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:o=\"urn:schemas-microsoft-com:office:office\">\n"
					+ "<head>\n"
					...
					+ "        \n"
					+ "  <div style=\"line-height: 140%; text-align: left; word-wrap: break-word;\">\n"
					+ "    <p style=\"font-size: 14px; line-height: 140%; text-align: left;\"><span style=\"font-size: 28px; line-height: 39.2px; color: #ffffff; font-family: Lato, sans-serif;\">Cuponera&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; DWF</span></p>\n"
					+ "  </div>\n"
					+ "\n"
					+ "      </td>\n"
					+ "    </tr>\n"
					...
					+ "        \n"
					+ "  <div style=\"line-height: 140%; text-align: left; word-wrap: break-word;\">\n"
					+ "    <p dir=\"ltr\" style=\"font-size: 14px; line-height: 140%; text-align: center;\"><span style=\"font-size: 28px; line-height: 39.2px; color: #ffffff; font-family: Lato, sans-serif;\">C&oacute;digo de verificaci&oacute;n</span></p>\n"
					+ "  </div>\n"
					+ "\n"
					+ "      </td>\n"
					+ "    </tr>\n"
					...
					+ "<div class=\"u-row-container\" style=\"padding: 0px;background-color: transparent\">\n"
					+ "  <div class=\"u-row\" style=\"Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #ffffff;\">\n"
					+ "    <div style=\"border-collapse: collapse;display: table;width: 100%;background-image: url('https://cdn.pixabay.com/photo/2020/01/02/10/15/background-image-4735444_1280.png');background-repeat: repeat;background-position: center top;background-color: transparent;\">\n"
					...
					+ "    <br />&nbsp; Hola, es un gusto "+nombreApellidoCliente+". <br />&nbsp; Nos alegra saber que deseas registrarte con nosotros<br />&nbsp; Al activar tu cuenta podr&aacute;s gozar de cientos&nbsp;<br />&nbsp;de beneficios&nbsp;\n"
					+ "  </h1>\n"
					+ "\n"
					+ "      </td>\n"
					+ "    </tr>\n"
					...
					+ "<p style=\"font-size: 14px; line-height: 140%;\">&nbsp;</p>\n"
					+ "<p style=\"line-height: 140%; font-size: 14px; text-align: left;\"><span style=\"color: #666666; font-size: 14px; line-height: 19.6px;\"><span style=\"font-size: 18px; line-height: 25.2px;\">&nbsp;"+nombreApellidoCliente+" este es tu c&oacute;digo de verificaci&oacute;n : <h1><b>"+tokem+"</b></h1> </span></span></p>\n"
					+ "  </div>\n"
					+ "\n"
					+ "      </td>\n"
					+ "    </tr>\n"
					...
					+ "        \n"
					+ "<div align=\"left\">\n"
					+ "  <!--[if mso]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:'Lato',sans-serif;\"><tr><td style=\"font-family:'Lato',sans-serif;\" align=\"left\"><v:roundrect xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:w=\"urn:schemas-microsoft-com:office:word\" href=\"http://localhost:8080/Desafio1_DWF/clientes.do?op=verificacion&tokenCliente=&quot;+tokem+&quot;\" style=\"height:51px; v-text-anchor:middle; width:195px;\" arcsize=\"2%\" stroke=\"f\" fillcolor=\"#18163a\"><w:anchorlock/><center style=\"color:#FFFFFF;font-family:'Lato',sans-serif;\"><![endif]-->\n"
					+ "    <a href=\"http://localhost:8080/Desafio1_DWF/clientes.do?op=verificacion&tokenCliente="+tokem+"\" target=\"_self\" style=\"box-sizing: border-box;display: inline-block;font-family:'Lato',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #18163a; border-radius: 1px; -webkit-border-radius: 1px; -moz-border-radius: 1px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;\">\n"
					+ "      <span style=\"display:block;padding:15px 40px;line-height:120%;\"><span style=\"font-size: 18px; line-height: 21.6px;\">Activar cuenta</span></span>\n"
					+ "    </a>\n"
					...
					+ "        \n"
					+ "  <div style=\"line-height: 140%; text-align: left; word-wrap: break-word;\">\n"
					+ "    <p style=\"line-height: 140%; font-size: 14px;\"><span style=\"font-size: 14px; line-height: 19.6px;\"><span style=\"color: #ecf0f1; font-size: 14px; line-height: 19.6px;\"><span style=\"line-height: 19.6px; font-size: 14px;\">Universidad Don Bosco</span></span></span></p>\n"
					+ "<p style=\"line-height: 140%; font-size: 14px;\"><span style=\"font-size: 14px; line-height: 19.6px;\"><span style=\"color: #ecf0f1; font-size: 14px; line-height: 19.6px;\"><span style=\"line-height: 19.6px; font-size: 14px;\"><br />Company &copy;&nbsp; All Rights Reserved</span></span></span></p>\n"
					+ "  </div>\n"
					+ "\n"
					+ "      </td>\n"
					+ "    </tr>\n"
